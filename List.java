...
public class List extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable2.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"1", "ali", "ali@gmail.com", "6", "..", "A"},
                {"2", "ahmed", "ahmed@gmail.com", "3", "..", "Ah"},
                {"3", "aqsa", "aqsa@gmail.com", "9", "..", "AQ"},
                {"4", "nida", "nida@gmail.com", "2", "..", "n"},
                {"5", "yasir", "yasir@gmail.com", "5", "..", null}
            },
            new String [] {
                "sr no.", "Employee Name", "employee ID", "no.of accessories", "accessories Name", "signature"
            }
        ));
